    ...
    <body>
        <div class="class-1">
            <div class="class-2">
                ...
                <h2 align="center">At Movie Munch, we pride ourselves on excellent customer service. Contact us today and experience it for yourself!</h2>
        ...
        <div class="class-3">
            ...
            <table border="0" class="tab" width="100%" height="100%" cellspacing="3">
                ...
                <tr>
                    <td>
                        <input type="email" class="textbox-size" readonly <%
                ...
                <tr>
                    <td>
                        <!-- <img src="https://thumbs.dreamstime.com/b/reset-224410204.jpg" height="60px" height="175px" alt=""> -->
                        <input type="reset" value="reset">
                    </td>
                    <td>
                        <!-- <a href=""><img src="https://thumbs.dreamstime.com/b/submit-button-vector-illustration-grey-black-web-icon-white-background-122223709.jpg" height="50px" height="170px" alt=""></a> -->
