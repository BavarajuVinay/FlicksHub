<html>
    <head>
        ...
        <script>
            var mv = "Bichagadu 2";
            var theater = "Swathi Theater: Bhavanipuram (Newly Renovated)";
...
<script>
    ...
    <body>
        <div class="first">
            <div class="image">
                <img src="https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/bichagadu-2-et00353721-1677564499.jpg" height="100%" weight="100%" alt="">
            </div>
            <div class="desc">
                <h1>Bichagadu 2</h1>
                <h2>&#11088;7.2/10</h2>7.5k votes
                <h3>2D</h3>
                <h3>Telugu</h3>
                <h3>1h 58m </h3>
                <h3>Action,Thriller &#x2022; UA &#x2022; 19 May, 2023</h3> 
                <!-- <a href="m1mbook.html"><button>Book Tickets</button></a> -->
            </div>
            <<div class="show_desc">
                <table border="0" cellpadding="15" cellspacing="4">
                    <tr>
                        <h2>&ensp; Swathi Theater: Bhavanipuram (Newly Renovajsp &ensp;&ensp;<font style="color: red;">&#9888; Non Cancellable</font> </h2>
                    </tr>
                    <tr>
        ...
        <div class="second">
           <div class="about">
                ...
                <h2>Bichagadu 2 is a Telugu movie starring Vijay Antony, Kavya Thapar, Hareesh Peradi, and John Vijay in prominent roles. It is written and directed by Vijay Antony.</h2>
                <h1>Cast</h1>
                <div class="cast">
                    <div class="ca1">
                        <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/vijay-anthony-7790-22-11-2017-10-59-52.jpg" style="border-radius: 50%;" height="100%" width="100%" alt="">
                        <h3>&ensp;Vijay Antony</h3>
                    </div>
                    <div class="ca2">
                        <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/kavya-thapar-1093441-15-09-2018-12-25-45.jpg" style="border-radius: 50%;" height="100%" width="100%" alt="">
                        <h3>&ensp;Kavya Thapar</h3>
                    </div>
                    <div class="ca3">
                        <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/hareesh-peradi-37560-1669615969.jpg" style="border-radius: 50%;" height="100%" width="100%" alt="">
                        <h3>&ensp;Hareesh Peradi</h3>
                    </div>
                    <div class="ca4">
                    <img src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/john-vijay-7760-24-03-2017-18-01-55.jpg" style="border-radius: 50%;" height="100%" width="100%" alt="">
                        <h3>&ensp;John Vijay</h3>
                    </div>
                </div>
                <div class="crew">
                    <h1>Crew</h1>
